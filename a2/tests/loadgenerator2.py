...
def send_requests_synchronously(url, requests_per_second, duration_seconds):
    ...
    while True:
        ...
        user_post_data = {"command": "update", "id": id, "username": "tester", "email": "test@example.com", "password": "password"}
        product_post_data = {"command": "update", "id": id, "name": "Product Name", "description": "Product Description", "price": 20, "quantity": 1000}
...
if __name__ == "__main__":
    ...
    requests_per_second = 120000  # Adjusted for a more realistic demonstration
